...
<h3 class="display-3" style="text-align: center;">Edit Student</h3><hr><br>
...
<div class="form-group">
    ...
    <div class="col-md-9">
        <?php echo form_input(['name'=>'course','class'=>'form-control','placeholder'=>'Enter Course',
                  'value'=>set_value('username',$studentData->course)]); ?>
    </div>
</div>
	</div>
	<div class="col-md-6">
