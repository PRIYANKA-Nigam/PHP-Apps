...
<li class="nav-item">
        ...
        <li class="nav-item">
        <a class="nav-link active" aria-current="page" href="<?= base_url().'Welcome/Blog'?>">Reference Material</a>
        </li>
      </ul>
...
<div class="container text-center">
  <div class="row g-2">
    <div class="col-5" >
     ...
     aria-expanded="false" aria-controls="collapseWidthExample" >
      <h3 style="color:white;" class="gtl"><center>AI/ML/Robotics/Data Science</center></h3></div> 
  ...
  <div class="collapse collapse-horizontal" id="collapseWidthExample">
    ...
    <div class="col-5 offset-2">
      <div class="p-5" class="btn btn-primary" data-bs-toggle="collapse" data-bs-target="#collapseWidthExample" 
     aria-expanded="false" aria-controls="collapseWidthExample">
      <h2 style="color:white;" class="gtl"><center>Microservices</center></h2>
  ...
  <div class="collapse collapse-horizontal" id="collapseWidthExample">
    ...
    <div class="col-5" style="margin-top:100px">
      <div class="p-5" class="btn btn-primary" data-bs-toggle="collapse" data-bs-target="#collapseWidthExample" 
     aria-expanded="false" aria-controls="collapseWidthExample">
      <h2 style="color:white;" class="gtl"><center>Android/IOS Development</center></h2>
      <div style="min-height: 120px;">
  <div class="collapse collapse-horizontal" id="collapseWidthExample">
    ...
    <div class="col-5 offset-2" style="margin-top:100px">
      <div class="p-5" class="btn btn-primary" data-bs-toggle="collapse" data-bs-target="#collapseWidthExample" 
     aria-expanded="false" aria-controls="collapseWidthExample" >
      <h2 style="color:white;" class="gtl"><center>DevOps Engineering</center></h2>
      <div style="min-height: 120px;">
  <div class="collapse collapse-horizontal" id="collapseWidthExample">
